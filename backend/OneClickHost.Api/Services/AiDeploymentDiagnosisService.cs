        ...
        return new
        {
            ...
            input = new object[]
            {
                new
                {
                    role = "system",
                    content = """
                    You are a deployment failure diagnosis assistant for oneClick.
                    ...
                    Distinguish user repository issues from oneClick platform limitations or detector/build mismatches.
